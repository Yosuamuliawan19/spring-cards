...
function Deck(prop) {
  ...
  const baseLineX = prop.baseLineX, baseLineY = prop.baseLineY;
  ...
  render() {
    return (
      <form className="information-container">
        <input className="information-title" type="text" value={this.state.cards[this.state.selectedCard].title} onChange={e => this.handleTitle(e)}/>
        <textarea   className="information-content" value={this.state.cards[this.state.selectedCard].content} onChange={e => this.handleContent(e)}/>
...
const backgroundColours = [
  '#ddf3f5', '#f1c5c5', '#faf0af', '#e5edb7', '#8bcdcd',
   '#a6dcef', 'linear-gradient(to right, #b993d6, #8ca6db)'
]
function BackButton(){
  return (
    <div className={"back-btn"}>
<svg  class="icon icon-tabler icon-tabler-arrow-back-up" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
class App extends React.Component {
  constructor(props){
    ...
    this.state = {
      ...
      selectedCard: 0, 
      cards: [
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604736980/polaroid/austrian-national-library-6QyLdHVIbxw-unsplash_thfuly.jpg', title:"On memory", content: "Our memory is made up of our individual memories and our collective memories. The two are intimately linked. And history is our collective memory. If our collective memory is taken from us - is rewritten - we lose the ability to sustain our true selves."},
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604737006/polaroid/annie-spratt--9vMBjrU-RA-unsplash_wilykq.jpg', title:"title2", content: "content"},
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604736969/polaroid/caleb-george-iVXfOilGYHA-unsplash_z2tsru.jpg', title:"title3", content: "content"},
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604736980/polaroid/austrian-national-library-6QyLdHVIbxw-unsplash_thfuly.jpg', title:"title4", content: "content"},
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604737006/polaroid/annie-spratt--9vMBjrU-RA-unsplash_wilykq.jpg', title:"title5", content: "content"},
        {img: 'https://res.cloudinary.com/yosuam19/image/upload/v1604736969/polaroid/caleb-george-iVXfOilGYHA-unsplash_z2tsru.jpg', title:"title6", content: "content"}
      ], 
      baseLineX : -300,
      baseLineY : 0,
    }
  ...
  render() {
    return <div style={{background: this.state.currentBackgroundColour}} className={"bg"}>
  ...
  {/* <div>{this.state.selectedCard}</div> */}
    <InformationSection cards={this.state.cards} setCardTitle={(idx, title) => this.setCardTitle(idx,title)} setCardContent={(idx, content) => this.setCardContent(idx,content)} selectedCard={this.state.selectedCard}/>
    <CirclePicker colors={backgroundColours} className="colour-picker" onChange={ (color, e) => this.handleBackgroundColorChange(color, e)} />
  </div>
  }
}
export default App;